    ...
    >
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            <Link
                ...
                :href="route('central.dashboard.index')"
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">App Central / Dominio principal</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Proyecto base multi tenancy usando tenancyforlaravel: https://tenancyforlaravel.com/docs/v3/introduction
                            </p>
                        </div>
